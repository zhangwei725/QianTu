...
import com.zw.retrofitlib.exception.ConfigLoader;
import com.zw.retrofitlib.exception.FormatException;
import com.zw.retrofitlib.exception.RetrofitException;
import com.zw.retrofitlib.exception.ServerException;
import com.zw.retrofitlib.utils.Utils;
...
public final class RetrofitManager {
    ...
    RetrofitManager(okhttp3.Call.Factory callFactory, String baseUrl, Map<String, String> headers,
...
*/
    ...
    public static final class Builder {
        ...
        public RetrofitManager build() {
             ...
             * outgoing HTTP requests.
             *
             * <p>If unset, {@link RetrofitManager CookieManager#NO_COOKIES no cookies} will be accepted nor provided.
             */
            ...
            return new RetrofitManager(callFactory, baseUrl, headers, parameters, apiManager, converterFactories, adapterFactories,
    ...
    class NovateSubscriber<T> extends BaseSubscriber<ResponseBody> {
        ...
        @Override
        public void onError(RetrofitThrowable e) {
            if (callBack != null) {
                callBack.onError(e);
            }
        }
